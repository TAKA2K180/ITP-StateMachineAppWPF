...
namespace Stateless.Tests
{
    public class IgnoredTriggerBehaviourFixture
    {
        ...
        {
            var ignored = new Classes.StateMachine<State, Trigger>.IgnoredTriggerBehaviour(Trigger.X, null);
        ...
        {
            var ignored = new Classes.StateMachine<State, Trigger>.IgnoredTriggerBehaviour(
                Trigger.X, null);
        ...
        {
            var ignored = new Classes.StateMachine<State, Trigger>.IgnoredTriggerBehaviour(
                Trigger.X, new Classes.StateMachine<State, Trigger>.TransitionGuard(False));
        ...
        {
            var ignored = new Classes.StateMachine<State, Trigger>.IgnoredTriggerBehaviour(
                Trigger.X, new Classes.StateMachine<State, Trigger>.TransitionGuard(True));
        ...
        public void IgnoredTriggerMustBeIgnoredSync()
        {
            ...
            var stateMachine = new Classes.StateMachine<State, Trigger>(State.B);
