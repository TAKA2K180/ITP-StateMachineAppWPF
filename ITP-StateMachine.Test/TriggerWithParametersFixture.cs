...
namespace Stateless.Tests
{
    public class TriggerWithParametersFixture
    {
        ...
        {
            var twp = new Classes.StateMachine<State, Trigger>.TriggerWithParameters<string>(Trigger.X);
        ...
        {
            var twp = new Classes.StateMachine<State, Trigger>.TriggerWithParameters<object>(Trigger.X);
            twp.ValidateParameters(new[] { "arg" });
        }
        ...
        {
            var twp = new Classes.StateMachine<State, Trigger>.TriggerWithParameters<string, string>(Trigger.X);
        ...
        public void StateParameterIsNotAmbiguous()
        {
            ...
            Classes.StateMachine<State, Trigger>.TriggerWithParameters<State> pressTrigger = fsm.SetTriggerParameters<State>(Trigger.X);
        ...
        {
            var twp = new Classes.StateMachine<State, Trigger>.TriggerWithParameters(Trigger.X, new Type[] { typeof(int), typeof(string) });
            Assert.Throws<ArgumentException>(() => twp.ValidateParameters(new object[] { 123 }));
        }
        ...
        {
            var twp = new Classes.StateMachine<State, Trigger>.TriggerWithParameters<int>(Trigger.X);
        ...
        {
            var twp = new Classes.StateMachine<State, Trigger>.TriggerWithParameters<int, string>(Trigger.X);
        ...
        {
            var twp = new Classes.StateMachine<State, Trigger>.TriggerWithParameters<int, string, List<bool>>(Trigger.X);
            var args = twp.ArgumentTypes.ToList();
