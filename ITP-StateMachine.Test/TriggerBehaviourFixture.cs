...
namespace Stateless.Tests
{
    public class TriggerBehaviourFixture
    {
        ...
        {
            var transitioning = new Classes.StateMachine<State, Trigger>.TransitioningTriggerBehaviour(
        ...
        {
            var transitioning = new Classes.StateMachine<State, Trigger>.TransitioningTriggerBehaviour(
                Trigger.X, State.C, new Classes.StateMachine<State, Trigger>.TransitionGuard(False));
        ...
        {
            var transitioning = new Classes.StateMachine<State, Trigger>.TransitioningTriggerBehaviour(
                Trigger.X, State.C, new Classes.StateMachine<State, Trigger>.TransitionGuard(True));
        ...
        public void WhenOneOfMultipleGuardConditionsFalse_GuardConditionsMetIsFalse()
        {
            ...
            var transitioning = new Classes.StateMachine<State, Trigger>.TransitioningTriggerBehaviour(
                Trigger.X, State.C, new Classes.StateMachine<State, Trigger>.TransitionGuard(falseGuard));
        ...
        public void WhenAllGuardConditionsTrue_GuardConditionsMetIsTrue()
        {
            ...
            var transitioning = new Classes.StateMachine<State, Trigger>.TransitioningTriggerBehaviour(
                Trigger.X, State.C, new Classes.StateMachine<State, Trigger>.TransitionGuard(trueGuard));
